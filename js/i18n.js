...
(function () {
  ...
  var DICT = {
    es: {
      ...
      "Word Search.desc":
        "Encuentra palabras tech en la cuadrícula neón. 8 direcciones, 3 dificultades y récord de tiempo.",
      "ws.pageTitle": "Sopa de Letras Neón | Portafolio Gamer",
      "ws.title": "SOPA DE LETRAS",
      "ws.back": "← Portafolio",
      "ws.backPortfolio": "← Volver al portafolio",
      "ws.difficulty": "Dificultad",
      "ws.easy": "Fácil · 8×8",
      "ws.normal": "Normal · 10×10",
      "ws.hard": "Difícil · 12×12",
      "ws.newGame": "NUEVA",
      "ws.pause": "PAUSA",
      "ws.found": "Encontradas",
      "ws.time": "Tiempo",
      "ws.words": "Palabras",
      "ws.hint": "Arrastra sobre las letras · 8 direcciones ·",
      "ws.hintPause": "pausa",
      "ws.modalTitle": "SOPA DE LETRAS",
      "ws.modalSub":
        "Encuentra todas las palabras ocultas en la cuadrícula neón",
      "ws.rule1": "Horizontal, vertical y diagonal",
      "ws.rule2": "Hacia adelante o hacia atrás",
      "ws.rule3": "Arrastra con el dedo o el mouse",
      "ws.start": "INICIAR",
      "ws.paused": "PAUSA",
      "ws.waiting": "Las letras esperan",
      "ws.continue": "CONTINUAR",
      "ws.newMatch": "NUEVA PARTIDA",
      "ws.toResume": "para reanudar",
      "ws.completed": "¡COMPLETADO!",
      "ws.timeLabel": "Tiempo:",
      "ws.best": "Mejor:",
    ...
    en: {
      ...
      "Word Search.desc":
        "Find tech words in the neon grid. 8 directions, 3 difficulties, and time record.",
      "ws.pageTitle": "Neon Word Search | Gamer Portfolio",
      "ws.title": "WORD SEARCH",
      "ws.back": "← Portfolio",
      "ws.backPortfolio": "← Back to portfolio",
      ...
      "ws.time": "Time",
      "ws.words": "Words",
      "ws.hint": "Drag over letters · 8 directions ·",
      "ws.hintPause": "pause",
      "ws.modalTitle": "WORD SEARCH",
      "ws.modalSub": "Find all hidden words in the neon grid",
      "ws.rule1": "Horizontal, vertical and diagonal",
      "ws.rule2": "Forward or backward",
      "ws.rule3": "Drag with finger or mouse",
      "ws.start": "START",
      "ws.paused": "PAUSED",
      "ws.waiting": "Letters are waiting",
      "ws.continue": "RESUME",
      "ws.newMatch": "NEW GAME",
      "ws.toResume": "to resume",
